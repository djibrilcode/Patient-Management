...
public function index()
{
    ...
    // Variables dynamiques initialisées à null
    $patientCount = null;
    $medecinCount = null;
    $rdvCount = null;
    ...
    if ($user->role === 'medecin') {
       ...
       // Statistiques des rendez-vous par mois (sur 12 mois)
    ...
    // Crée un tableau complet pour 12 mois, même s’il n’y a pas de données
    $rdvChartData = [];
    for ($i = 1; $i <= 12; $i++) {
